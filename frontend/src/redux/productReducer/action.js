...
export const addResumedata = (payload, headers) => (dispatch) => {
    ...
    axios.post("https://swnirbhar-2.onrender.com/resumes/", payload, headers)
        .then((res) => {
            console.log('res:', res);
...
export const getResumeData = (headers) => (dispatch) => {
    dispatch(resumeDataRequestAction());
    axios.get(`https://swnirbhar-2.onrender.com/resumes`, headers)
        .then((res) => {
...
export const deleteResumeData = (id, headers) => (dispatch) => {
    dispatch(resumeDataRequestAction());
    axios.delete(`https://swnirbhar-2.onrender.com/resumes/${id}`, headers)
        .then((res) => {
            console.log('res:', res.data);
...
export const EditResumeData = (payload, id, headers) => (dispatch) => {
    dispatch(resumeDataRequestAction());
    return axios.put(`https://swnirbhar-2.onrender.com/resumes/${id}`, payload, headers)
        .then((res) => {
            console.log('res:', res.data);
